...
setup(
    ...
    description="Wrapper for creativecommons.tankerkoenig.de API",  # Optional
    ...
    url="https://github.com/hugohabicht01/tankerkoenig-python",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="hugohabicht01",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="jodeldiplominhaber@pm.me",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/hugohabicht01/tankerkoenig-python/issues",
        "Source": "https://github.com/hugohabicht01/tankerkoenig-python",
    },
)
